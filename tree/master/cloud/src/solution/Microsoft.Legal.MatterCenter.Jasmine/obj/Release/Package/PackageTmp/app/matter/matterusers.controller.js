(function () {
    ...
    function ($scope, $state, $stateParams, api, matterResource, $filter, $window, $rootScope, $location) {
        ...
        if (cm.clientUrl === "" && cm.matterName === "") {
            ...
            cm.clientUrl = oEnvironmentConfiguration.tenantUrl + "/sites/microsoft";
            cm.isEdit = "true";
        }
        ...
        cm.addNewAssignPermissions = function () {
            ...
            cm.assignPermissionTeams.push({ 'assigneTeamRowNumber': newItemNo, 'assignedRole': cm.assignRoles[0], 'assignedPermission': cm.assignPermissions[0], userConfirmation: false });
        };
